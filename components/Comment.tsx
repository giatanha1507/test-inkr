				...
				<div style={{ marginLeft: '16px' }}>
					<div style={{ display: 'flex', alignItems: 'center' }}>
						<p
							...
							style={{ marginRight: 8, fontSize: 12, lineHeight: '18px' }}
						>
							Han Solo
						</p>
						<span
							className={styles['card-desc']}
							style={{ marginRight: 8, fontSize: 11, lineHeight: '18px', color: '#535353' }}
						>
					...
					<p
						className={styles['card-desc']}
						style={{ marginBottom: 16, paddingRight: 48, color: 'white' }}
					>
					...
					<div style={{ display: 'flex', color: 'white' }}>
						<div style={{ marginRight: 10 }}>
							<LikeOutlined />
							<span className={styles['card-desc']} style={{ marginLeft: 8, fontSize: 12 }}>
								61
							</span>
						</div>
						<div style={{ marginRight: 10 }}>
						...
						<div className={styles['card-desc']} style={{ cursor: 'pointer', fontWeight: 500 }}>
							Reply
						</div>
					</div>
				</div>
