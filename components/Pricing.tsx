				...
				<Col span={12}>
					...
					>
						<p
							...
							style={{ textTransform: 'uppercase', color: 'rgba(255, 255, 255, 0.45)' }}
						>
							free
						</p>
			...
			<Row style={{ width: '100%' }}>
				<Col span={24}>
					<Card
						extra={
							...
							>
								...
								<p className={styles['card-text']} style={{ fontWeight: 700 }}>
									{lockedChapters.length * novel.pricePerChap}
								</p>
							</Tag>
						}
						style={{
					...
					>
						...
						<p className={styles['comment-text']} style={{ color: 'rgba(255, 255, 255, 0.45)' }}>
			...
			<Row>
				<Col span={24}>
					<Card
						extra={
							<div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
								...
								>
									...
									<p className={styles['card-text']} style={{ fontWeight: 700 }}>
										{Math.ceil(lockedChapters.length * novel.pricePerChap * novel.discount)}
									</p>
								</Tag>
							</div>
						}
						...
						hoverable={false}
					>
						<p className={styles['card-text']} style={{ color: '#A379FF' }}>
							Save money with INKR Extra
							<CrownFilled style={{ paddingLeft: 4 }} />
						</p>
						<p className={styles['comment-text']} style={{ color: 'rgba(255, 255, 255, 0.45)' }}>
